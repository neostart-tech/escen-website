                ...
                <div class="relative">
                    <div class="relative h-[500px] lg:h-[400px] overflow-hidden rounded-2xl ">
                        <div class="flex transition-transform duration-700 ease-out"
                            ...
                            <!-- Groupes de 2 témoignages -->
                            <div v-for="(group, groupIndex) in groupedTestimonials" :key="groupIndex"
                                 class="w-full flex-shrink-0 px-3">
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
                                    <!-- Premier témoignage du groupe -->
                                    <div v-for="(testimonial, index) in group" :key="index"
                                         class="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full items-center">
                                        <div class="lg:col-span-1">
                                            <div class="relative group">
                                              ...
                                              <div class="mb-4 bg-white rounded-xl p-3 lg:p-4 shadow-lg border border-gray-200 w-full transition-all duration-300 testimonial-info responsive-info-card">
                                                ...
                                                <div class="relative z-10">
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div class="flex items-center gap-2 text-gray-500">
                                                            <span class="text-xl font-bold text-[#01b4d5]">{{ String(groupIndex * 2 + index + 1).padStart(2, '0') }}</span>
                    ...
                    <div class="flex justify-center items-center gap-4 mt-8">
                        ...
                        <div class="flex gap-2">
                            <button v-for="n in groupedTestimonials.length" :key="n"
                                    @click="goToSlide(n-1)"
...
// Regrouper les témoignages par 2
...
const nextSlide = () => {
    currentSlide.value = (currentSlide.value + 1) % groupedTestimonials.value.length
}

const prevSlide = () => {
    currentSlide.value = (currentSlide.value - 1 + groupedTestimonials.value.length) % groupedTestimonials.value.length
}
...
/* Ajustements pour l'affichage en 2 colonnes */
@media (max-width: 1024px) and (min-width: 769px) {
    .relative.h-\[500px\].lg\:h-\[400px\] {
        height: 700px; /* Augmenté pour contenir 2 témoignages */
        min-height: 700px;
    }
...
@media (max-width: 768px) {
    /* Sur mobile, revenir à 1 témoignage à la fois */
