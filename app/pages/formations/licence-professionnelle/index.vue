...
const handleDownloadClick = async (formation) => {
  ...
  if (savedProspect) {
    ...
    try {
      ...
      console.error("Erreur téléchargement:", e.response?.data || e)
    } finally {
...
// Tableau des formations MIS À JOUR avec le chemin vers Fiche_Licence_FD.pdf
const formations = [
    {
        id: 1,
        ...
        brochure: "/pdf/Fiche_Licence_MD.pdf",
        detailsUrl: "/formations/licence-professionnelle/marketing-digital"
    },
    {
        id: 2,
        type: "Licence Professionnelle",
        ...
        brochure: "/pdf/Fiche_Licence_FD.pdf",
        detailsUrl: "/formations/licence-professionnelle/finance-digitale"
    },
    {
        id: 3,
        type: "Licence Professionnelle",
        ...
        brochure: "/pdf/Fiche_Licence_MPN.pdf",
        detailsUrl: "/formations/licence-professionnelle/management-projets"
    },
    {
        id: 4,
        type: "Licence Professionnelle",
        ...
        brochure: "/pdf/Fiche_Licence_IA.pdf",
        detailsUrl: "/formations/licence-professionnelle/intelligence-artificielle"
    }
]

// Computed properties (inchangés)
...
// Méthodes d'helpers pour les classes (inchangées)
...
// SUPPRIMÉ la fonction telechargerBrochure - on utilise maintenant un lien direct
