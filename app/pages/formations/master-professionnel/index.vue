  ...
  <div class="min-h-screen bg-white">
    ...
    <section class="py-12 lg:py-20 bg-white">
      <div class="container mx-auto px-4 md:px-8 lg:px-22 max-w-7xl">
        ...
        <div v-else>
          <div
            v-for="(formation, index) in paginatedFormations"
            :key="formation.id"
          ...
          >
            ...
            <div :class="getContentPosition(index)">
              ...
              <h2
                class="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-6"
              >
                {{ formation.titre }}
              </h2>
    ...
    <section class="py-20 bg-gradient-to-r from-[#01b4d5] to-[#0056b3]">
      <div
        class="container mx-auto px-4 lg:px-6 max-w-4xl text-center text-white"
      >
        <h2 class="text-3xl lg:text-4xl xl:text-5xl font-bold mb-6">
          Prêt à transformer votre avenir ?
        </h2>
        <p class="text-xl lg:text-2xl mb-8 opacity-90">
          Rejoignez l'ESCEN et bénéficiez d'une formation d'excellence aux
...
const formations = [
  ...
  },
  {
    ...
    // pointsCles: [
    //   "Double expertise : management et transformation digitale",
    //   "Maîtrise complète du cycle de vie des projets",
    //   "Préparation aux certifications CAPM® et PMP® du PMI",
    // ],
    brochure: "/pdf/Fiche_Master_MP&TD.pdf",
...
const getIconPosition = (index) => {
  const globalIndex = (currentPage.value - 1) * itemsPerPage.value + index;
  const baseClasses =
    "absolute w-16 h-16 md:w-24 md:h-24 rounded-xl md:rounded-2xl flex items-center justify-center shadow-2xl";
...
const getPrimaryButtonClasses = (index) => {
  const globalIndex = (currentPage.value - 1) * itemsPerPage.value + index;
  const baseClasses =
    "text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center justify-center gap-3";
  return globalIndex % 2 === 0
...
const getSecondaryButtonClasses = (index) => {
  const globalIndex = (currentPage.value - 1) * itemsPerPage.value + index;
  const baseClasses =
    "border-2 px-8 py-4 rounded-xl font-semibold transition-all duration-300";
  return globalIndex % 2 === 0
